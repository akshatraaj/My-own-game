...
function setup(){
  ...
  child.visible = false;
 // child.debug = true;
  kidnapper = createSprite(50,50,20,20);
  ...
  upArrow = createSprite(displayWidth - 1200,displayHeight - 300);
  upArrow.scale = 0.2;
 // wall1.visible = false;
  upArrow.addImage(uaimg);
  upArrow.visible = false;
  downArrow = createSprite(displayWidth - 1200,displayHeight - 170);
  downArrow.addImage(daimg);
  downArrow.scale = 0.4;
  downArrow.visible = false;
  leftArrow = createSprite(displayWidth - 1270,displayHeight - 220);
  leftArrow.addImage(laimg);
  leftArrow.scale = 0.2;
  leftArrow.visible = false;
  rightArrow = createSprite(displayWidth - 1140,displayHeight - 220);
  rightArrow.addImage(raimg);
